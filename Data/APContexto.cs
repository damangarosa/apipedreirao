...
namespace ApiPedreirao.Data
{
    public class APContexto : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
          ...
          mb.Entity<Perfil>().ToTable("Perfil").HasKey(pe => pe.Id).HasName("PrimaryKey_BlogId");
           ...
           mb.Entity<FechaNegocio>().ToTable("FechaNegocio").HasKey(fh => fh.Id);
            ...
            //mb.Entity<FechaNegocio>().ToTable("FechaNegocio").Property(p => p.DataFechamento).HasDefaultValueSql("GetUtcDate()"); //HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed);
